...
config_in_root = (os.path.exists(settings_path_root) and os.path.exists(shadow_config_path_root))
...
class Settings(object):
    ...
    def set_config_files(self, config_file=DEFAULT_CONFIG_FILE, shadow_file=DEFAULT_SHADOW_FILE):
    ...
    def parse_config_file(self):
        ...
        # this will override anything that is found in the other config
